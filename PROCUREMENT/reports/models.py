...
class PendingPRReport(ReportSnapshotMixin):
    ...
    authorized_status = models.CharField(max_length=50, blank=True)
...
class CompletePRReport(ReportSnapshotMixin):
    ...
    qty = models.DecimalField(max_digits=14, decimal_places=2, default=Decimal("0.00"))
    uom = models.CharField(max_length=50, blank=True)
    po_no = models.TextField(blank=True)
    po_status = models.TextField(blank=True)
    l1_action_by_date = models.TextField(blank=True)
    l2_action_by_date = models.TextField(blank=True)
    l3_action_by_date = models.TextField(blank=True)
    po_qty = models.DecimalField(max_digits=14, decimal_places=2, default=Decimal("0.00"))
    vendor_name = models.TextField(blank=True)
    grn_srn_number = models.TextField(blank=True)
    grn_srn_date = models.TextField(blank=True)
    prepared_by = models.CharField(max_length=255, blank=True)
    prepared_date = models.DateTimeField(blank=True, null=True)
    authorized_by = models.CharField(max_length=255, blank=True)
    authorized_date = models.DateTimeField(blank=True, null=True)
...
class CompleteGRNReport(ReportSnapshotMixin):
    ...
    rate = models.DecimalField(max_digits=14, decimal_places=2, default=Decimal("0.00"))
    total_value = models.DecimalField(max_digits=14, decimal_places=2, default=Decimal("0.00"))
    prepared_by_dt = models.TextField(blank=True)
    checked_by = models.CharField(max_length=255, blank=True)
    authorized_by_dt = models.TextField(blank=True)
...
class PendingSRNReport(ReportSnapshotMixin):
    ...
    srn_no = models.CharField(max_length=100, blank=True)
    srn_date = models.CharField(max_length=50, blank=True)
    status = models.CharField(max_length=100, blank=True)
